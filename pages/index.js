...
export default function Home() {
  return (
    <>
    <Header/>
    <div className='py-4 min-h-[90vh] flex flex-wrap  justify-center'>
<div className='px-[5rem] mt-[1rem] lg:mt-[9rem] min-w-[100vw] lg:min-w-[300px] flex justify-top flex-col items-center'>
  <h5 className='text-white text-[2rem] md:text-[4rem] font-bold '>Welcome Every One </h5>
  <p className='text-[#717377] md:text-[1.5rem] text-[1rem] mb-8'>Let s Pay games</p>
